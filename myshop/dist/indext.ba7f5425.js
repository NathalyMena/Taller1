...
function mousePressed() {
    switch(pantalla){
        case 0:
            if (mouseX > 764 && mouseX < 1114 && mouseY > 768 && mouseY < 846) pantalla = 1;
            break;
        case 1:
            if (mouseX > 532 && mouseX < 882 && mouseY > 736 && mouseY < 814) {
                pantalla = 2;
                puntaje++;
            } else if (mouseX > 955 && mouseX < 1305 && mouseY > 736 && mouseY < 814) pantalla = 6;
            break;
        case 2:
            if (mouseX > 955 && mouseX < 1305 && mouseY > 736 && mouseY < 814) {
                pantalla = 3;
                puntaje++;
            } else if (mouseX > 532 && mouseX < 882 && mouseY > 736 && mouseY < 814) pantalla = 6;
            break;
        case 3:
            if (mouseX > 955 && mouseX < 1305 && mouseY > 736 && mouseY < 814) {
                pantalla = 4;
        ...
        case 5:
            ...
            break;
        case 6:
            if (mouseX > 950 && mouseX < 1300 && mouseY > 665 && mouseY < 743) {
                pantalla = 0;
                puntaje = 0;
            }
            break;
...
function draw() {
    ...
    switch(pantalla){
        case 0:
            ...
            image(darle, 940, 768);
            if (mouseX > 940 && mouseX < 1290 && mouseY > 768 && mouseY < 846) cursor(HAND);
            else if (mouseX > 540 && mouseX < 890 && mouseY > 768 && mouseY < 846) cursor(HAND);
            break;
        case 1:
            imageMode(CORNER);
            ...
            fill(255);
            textAlign(CENTER);
            text("¿La Tortuga Carey está en vía de extinsión?", 150, 202, 1155, 214);
            imageMode(CENTER);
            switch(puntaje){
                case 0:
            ...
            if (mouseX > 532 && mouseX < 882 && mouseY > 736 && mouseY < 814) cursor(HAND);
            else if (mouseX > 955 && mouseX < 1305 && mouseY > 736 && mouseY < 814) cursor(HAND);
            if (mousePressed.mouseX > 532 && mouseX < 882 && mouseY > 736 && mouseY < 814) cursor(HAND);
            imageMode(CENTER);
            image(si, 532, 736);
            image(no, 955, 736);
            break;
        case 2:
            ...
            fill(255);
            textAlign(CENTER);
            text("¿Cuánto tiempo viven los frailejones aproximandamente?", 150, 190, 1155, 214);
            imageMode(CENTER);
            switch(puntaje){
                case 0:
                    image(p0, width / 2, 142);
        ...
        case 3:
            ...
            fill(255);
            textAlign(CENTER);
            text("¿Cuál es el páramo más grande del mundo?", 150, 190, 1155, 214);
            imageMode(CENTER);
            switch(puntaje){
                case 0:
                    image(p0, width / 2, 142);
        ...
        case 4:
            ...
            fill(255);
            textAlign(CENTER);
            text("¿Tener de mascota una Guacamaya es lega?", 150, 190, 1155, 214);
            imageMode(CENTER);
            switch(puntaje){
                case 0:
                    image(p0, width / 2, 142);
        ...
        case 5:
            ...
            fill(255);
            textAlign(CENTER);
            text("¿El Oso de Anteojos es el animal nacional de Colombia?", 150, 190, 1155, 214);
            imageMode(CENTER);
            switch(puntaje){
                case 0:
                    image(p0, width / 2, 142);
        ...
        case 6:
            ...
            if (puntaje == 5) {
                ...
                if (mouseX > 550 && mouseX < 1100 && mouseY > 630 && mouseY < 743) cursor(HAND);
            } else {
                imageMode(CENTER);
                image(ups, width / 2, 400);
                if (mouseX > 950 && mouseX < 1300 && mouseY > 665 && mouseY < 743) cursor(HAND);
                else if (mouseX > 550 && mouseX < 900 && mouseY > 665 && mouseY < 743) cursor(HAND);
                imageMode(CENTER);
                image(again, 950, 665);
...
//# sourceMappingURL=indext.ba7f5425.js.map
